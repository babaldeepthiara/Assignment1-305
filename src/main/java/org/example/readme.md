...
Overview
This application accepts a public GitHub repository URL, fetches all .java source files, computes software design metrics per file, and displays them as a color-coded, transparency-scaled grid of interactive squares.
